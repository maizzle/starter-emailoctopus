...
With the upcoming GDPR legislation we've added an additional 2 templates which can be used to re-opt-in your users. They can be found within the [Abacus](https://github.com/maizzle/starter-emailoctopus/tree/master/src/templates/abacus) pack and the [Plain](https://github.com/maizzle/starter-emailoctopus/tree/master/src/templates/plain) pack.
